...
/* *** NOTE ***
   This file is based on trunk/src/sum.c r10225 of the MPFR repository.
   https://gforge.inria.fr/scm/viewvc.php/mpfr/trunk/src/sum.c?view=co&revision=10225
...
#ifndef MPFR_STAT_STATIC_ASSERT
